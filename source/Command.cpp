...
const Command Command::FIGHT(1uL << 21, G("Fleet: Fight my target"));
const Command Command::GATHER(1uL << 22, G("Fleet: Gather around me"));
const Command Command::HOLD(1uL << 23, G("Fleet: Hold position"));
const Command Command::AMMO(1uL << 24, G("Fleet: Toggle ammo usage"));
